...
reverse_pipe_img = pygame.transform.rotate(pipe_img, 180)
background = pygame.image.load("bg.png")
background = pygame.transform.scale(background, (WIDTH, HEIGHT))
font1 = pygame.font.SysFont("comic sans")
...
class pipe:
    ...
    def draw(self):
        ...
        uppipe = screen.blit(pipe_img, (self.x, self.height+80))
        downpipe = screen.blit(reverse_pipe_img, (self.x, self.height - HEIGHT))
